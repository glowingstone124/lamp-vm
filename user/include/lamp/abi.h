...
enum {
    LAMP_O_ACCMODE = 0x00000003u,
    LAMP_O_RDONLY = 0x00000000u,
    LAMP_O_WRONLY = 0x00000001u,
    LAMP_O_RDWR = 0x00000002u,
    LAMP_O_CREAT = 0x00000040u,
    LAMP_O_TRUNC = 0x00000200u,
    LAMP_O_NONBLOCK = 0x00000800u,
    LAMP_O_CLOEXEC = 0x00080000u
};

enum {
    LAMP_FCNTL_F_DUPFD = 0u,
    LAMP_FCNTL_F_GETFD = 1u,
    LAMP_FCNTL_F_SETFD = 2u,
    LAMP_FCNTL_F_GETFL = 3u,
    LAMP_FCNTL_F_SETFL = 4u,
    LAMP_FCNTL_F_DUPFD_CLOEXEC = 5u,
    LAMP_FD_CLOEXEC = 0x00000001u
};

enum {
    LAMP_S_IFMT = 0xF000u,
    LAMP_S_IFSOCK = 0xC000u,
    LAMP_S_IFLNK = 0xA000u,
